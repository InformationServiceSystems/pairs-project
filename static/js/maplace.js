    ...
    */
    ...
    Maplace.prototype.add_markerEv = function(index, point, marker) {
        ...
        google.maps.event.addListener(marker, 'click', function(ev) {
            ...
            console.log("index of list is = "+ index)
            console.log("chart data in map.js" + chart1.data.datasets[0].data)

            if(index==0){
                document.getElementById("cap").innerHTML  = "Trostberg";
                chart1.data.datasets[0].data = [13,12,50,25]
              chart2.data.datasets[0].data = [28,36,33,3]
              chart3.data.datasets[0].data = [25,14,19,39]
              chart4.data.datasets[0].data = [29,23,33,17]
              chart5.data.datasets[0].data = [50,12,13,25]
              chart6.data.datasets[0].data = [12,15,17,56]
              chart7.data.datasets[0].data = [30,23,34,13]
              chart1.update();
              chart2.update();
              chart3.update();
              chart4.update();
            ...
            if(index==1){
                document.getElementById("cap").innerHTML  = "Raubling";
                chart1.data.datasets[0].data = [5,20,60,15]
          chart2.data.datasets[0].data = [38,28,21,13]
          chart3.data.datasets[0].data = [20,10,13,57]
          chart4.data.datasets[0].data = [32,19,36,13]
          chart5.data.datasets[0].data = [58,5,18,19]
          chart6.data.datasets[0].data = [44,15,13,28]
          chart7.data.datasets[0].data = [35,31,24,10]
          chart1.update();
          chart2.update();
          chart3.update();
          chart4.update();
          ...
          chart7.update();
            ...
            if(index==2){
document.getElementById("cap").innerHTML  = "Augsburg";
chart1.data.datasets[0].data = [45,17,20,18]
          chart2.data.datasets[0].data = [13,35,24,28]
          chart3.data.datasets[0].data = [50,35,8,7]
          chart4.data.datasets[0].data = [32,19,36,13]
          chart5.data.datasets[0].data = [28,15,28,39]
          chart6.data.datasets[0].data = [36,18,23,23]
          chart7.data.datasets[0].data = [31,21,24,24]
          chart1.update();
          chart2.update();
          chart3.update();
          chart4.update();
