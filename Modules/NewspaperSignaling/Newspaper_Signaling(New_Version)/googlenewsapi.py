...
class GoogleNews:
    def __init__(self, lang = 'de', country = 'Germany'):
...
def get_news(query, start_date, end_date, country='Germany', language='de'):
    gn = GoogleNews(country=country, lang=language)
    ...
    for date in date_list[:-1]:
        result = gn.search(query, from_=date.strftime('%Y-%m-%d'), to_=(date+delta).strftime('%Y-%m-%d'))
...
#query = "Energieknappheit" and "Energiesicherheit" and "Ölkrise" and "Gaskrise" \
#and "Stromkrise" and "energieeinsparung" and "energieeffizienz" and "fossile brennstoffe" and "kernenergie"\
#and "Kohlenstoffemissionen" and "Klimawandel" and "Stromausfall" and "Stromunterbrechung" and "Netzausfall" and "Rolling Blackouts" and "Brownouts"\
#and "Spannungsschwankungen" and  "Stromnetzes" \
#and "Brennstoff" and "Gaspreis" and "Strom" and "Stromkosten" and "Energie" and "Kohle" and "Stromnachfrage"\
#and "Energieerzeugung" and "Energieversorgung" and "Gaskosten" and "Energiekrise"\
#and "Solarenergie" and "Windenergie" and "Wasserkraft" and "Geothermie" and "Biomasseenergie" \
#and "erdöl" and "erdgas" and "energiespeicherung"


# df = pd.DataFrame(get_news(query))
# print(len(df))
# df.to_csv('outageDE12.csv')
